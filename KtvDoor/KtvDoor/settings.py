"""
Django settings for KtvDoor project.
...
SECRET_KEY = '_gl=*vb!uew6xp@t)x(i=km6octr_7dz%alo=*-x-07%y13@b6'
...
WSGI_APPLICATION = 'KtvDoor.wsgi.application'
